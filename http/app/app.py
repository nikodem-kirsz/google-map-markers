...
app.config["MONGO_URI"] = 'mongodb://niko:nikos992@ds015194.mlab.com:15194/heroku_cqdtt72x?retryWrites=false'
# app.config["MONGO_URI"] = 'mongodb://nk92:luneczka@localhost:27017/geomap'
...
def user_resources():
    energy_sources = mongo.db.energy_sources.find({'user_email': request.get_json()['user_email']})
    return dumps(list(energy_sources))
